...
beforeEach(function (): void {
    ...
    // Create all permissions used by assistant tools
    $permissions = [
        'assistant.use',
        'calendarEvent.viewAny', 'calendarEvent.view', 'calendarEvent.create', 'calendarEvent.update', 'calendarEvent.delete',
    ...
    $role = Role::create(['name' => 'assistant-user', 'guard_name' => 'web']);
    ...
    $this->service = app(AssistantToolRegistry::class);
});
